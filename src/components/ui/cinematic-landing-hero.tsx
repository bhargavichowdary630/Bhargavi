...
export function CinematicHero({ 
  ...
  cardDescription = <><span className="text-white font-semibold">Bhargavi Nimmagadda</span> is a results-driven Risk & Fraud Analyst with 3+ years of experience in transaction monitoring, fraud detection, KYC/AML compliance, and data analytics across U.S. fintech and global banking environments.</>,
  metricValue = 10000,
  metricLabel = "Txns Monitored Weekly",
  ctaHeading = "Let's connect.",
  ctaDescription = "Open to opportunities in risk analysis, fraud prevention, AML compliance, and financial crime investigation.",
  className, 
  ...props 
}: CinematicHeroProps) {
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="mailto:bhargavinchowdary@gmail.com" aria-label="Send email" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            ...
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Send an</div>
              <div className="text-xl font-bold leading-none tracking-tight">Email</div>
            </div>
          </a>
          <a href="#curriculum" onClick={(e) => { e.preventDefault(); document.querySelector('#curriculum')?.scrollIntoView({ behavior: 'smooth' }); }} aria-label="View expertise" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            <svg className="w-6 h-6 transition-transform group-hover:scale-105" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">View</div>
              <div className="text-xl font-bold leading-none tracking-tight">Expertise</div>
            </div>
          </a>
        </div>
      </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">Fiserv Platform</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">FraudOps</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">BN</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">3+ Years</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Fraud prevention</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Real-time</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Risk analytics</p>
                  </div>
                </div>
